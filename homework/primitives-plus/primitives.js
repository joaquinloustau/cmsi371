...
var Primitives = {
  ...
  circleTrig: function (context, xc, yc, r, innerColor, outerColor) {
    var theta = 1 / r,
    ...
    while (x >= y) {
      this.plotCirclePoints(context, xc, yc, x, y, r, innerColor, outerColor);
      x = x * c - y * s;
      y = x * s + y * c;
    }
  },
  ...
  // Now DDA.
  circleDDA: function (context, xc, yc, r, innerColor, outerColor) {
    var epsilon = 1 / r,
        x = r,
        y = 0;
  ...
  circleBres1: function (context, xc, yc, r, innerColor, outerColor) {
    var p = 3 - 2 * r,
        x = 0,
        y = r;
  ...
  // And another...
  circleBres2: function (context, xc, yc, r, innerColor, outerColor) {
    var x = 0,
        y = r,
        e = 1 - r,
        u = 1,
  ...
  // Last but not least...
  circleBres3: function (context, xc, yc, r, innerColor, outerColor) {
    var x = r,
        y = 0,
        e = 0;
